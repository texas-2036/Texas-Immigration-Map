...
labels <- sprintf("<a style = 'font-family: 'Titillium Web', -apple-system, BlinkMacSystemFont, Roboto, Helvetica, Arial, sans-serif; font-size: 24px; font-weight: 700; color:#3d3d3d'><strong>%s</strong></a> <br/> <strong>Country:</strong> %s",
                  pop_by_birth$name,
