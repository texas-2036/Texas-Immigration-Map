...
labels <- sprintf("<a style = 'font-family: -apple-system, BlinkMacSystemFont, Roboto, Helvetica, Arial, sans-serif; font-size: 24px; color:#3d3d3d'><strong>%s</strong></a> <br/> <strong>Country:</strong> %s",
                  pop_by_birth$name,
                  pop_by_birth$country) %>%
  lapply(htmltools::HTML)

pal <- colorFactor(palette=c("#d9eaf5", "#4e79a7", "#40515c", "#c8d0d9", "#f1ce63", "#e46769", "#ffbc79"), 
                   levels = c("Europe", "Asia", "South America", "Austrailia", "Africa", "North America", "Arctic"))

pop_map <- leaflet(pop_by_birth) %>%
  addTiles(urlTemplate = "https://api.mapbox.com/styles/v1/mrw03b/cji21nw3e03ht2rqz4kgte0ea/tiles/256/{z}/{x}/{y}@2x?access_token=pk.eyJ1IjoibXJ3MDNiIiwiYSI6IlYwb2FiOWcifQ.RWUm2a87fEC9XrDxzvZKKg",
...
htmlwidgets::saveWidget(widget = pop_map, file = "tx_immigration_map.html", selfcontained = TRUE, background = "white")
